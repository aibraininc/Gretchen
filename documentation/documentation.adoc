...
Insert components (RS485, 4-pin, white, rectangluar) and solder them.

[cols="a,a"]
|====
| *Before* | *After*
| image::sensorimotor_through_hole_parts.jpg[320,240] | image::sensorimotor_insert_polarized_capacitor.jpg[320,240]
|====

==== Step 1.1 Insert molex pin on top side of board.
...
==== Step 1.2 Insert thermistor on bottom side of board.
...
==== Step 1.3 Insert capacitor on bottom side of board.
...
==== Step 1.4 Insert ISP pin on top side of board.
...
==== Step 2.1 Cut the wires of encoder part
...
|====
| *Before* | *After*
| image::IMG-5833.jpg[320,240] | image::IMG-5847.jpg[320,240]
|====
...
|====
| *Before* | *After*
| image::IMG-5833.jpg[320,240] | image::IMG-5835.jpg[320,240]
|====
